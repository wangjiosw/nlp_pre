...
class seq2classesData(seq2seqData):
    def __init__(self, input_field, output_field, cols, batch_size, device, data_path='.', vectors=None):
        super(seq2classesData, self).__init__(input_field, output_field, cols, batch_size,
